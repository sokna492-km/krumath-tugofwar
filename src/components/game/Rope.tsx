  ...
  return (
    <div className="relative flex h-44 w-full items-center justify-center overflow-visible sm:h-56">
      ...
      >
        ...
        <div className="relative mx-[-6px] flex-1 -translate-y-2 sm:mx-[-10px] sm:-translate-y-3">
          <div
            className="h-2.5 w-full rounded-full shadow-md sm:h-3.5"
            style={{
              backgroundImage:
                "repeating-linear-gradient(55deg, oklch(0.52 0.09 75) 0px, oklch(0.52 0.09 75) 5px, oklch(0.38 0.07 70) 5px, oklch(0.38 0.07 70) 10px)",
            }}
          />
